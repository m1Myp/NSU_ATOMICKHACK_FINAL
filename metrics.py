...
for h_iter in range(18, 24):
    ...
    print(f"Итерация {h_iter}: Вторая метрика: {second_metric:.3f} Вт")
    print(f"Итерация {h_iter}: Третья метрика: {third_metric:.4f} В")
...
# Дополнительно: вывод в виде таблицы
print("\n" + "="*80)
